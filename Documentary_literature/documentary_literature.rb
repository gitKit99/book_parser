...
class DocumentaryLiterature
    ...
    save.saveToJson(File.join(File.dirname(__FILE__), "documentary_literature.json"), products)
    save.saveToYaml(File.join(File.dirname(__FILE__), "documentary_literature.yaml"), products)
end